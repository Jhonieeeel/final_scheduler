...
class ReplayAllUserBalance
{
    ...
    // many users
    public static function allTransactionsForUsers(Carbon $date, Collection $users): array
    {
    ...
    // protected static function remarks(Collection $filing): array {}
    ...
    protected static function calculateBalances(
        ...
        // $current already spans 2023-01-01 -> end of $date's month, so every
        // year in this loop is already inside $current — no extra query needed.
